...
const FEATURE_FLAGS = [
  ...
  {
    code: "FEAT_AI_BUILDER",
    name: "AI Builder (Ecosystem)",
    description: "Satu pintu semua kapabilitas AI: materi teks, gambar, aset visual CMS, audio, dan video",
    isActive: true,
    tier: FeatureTier.PREMIUM,
    category: "akademik",
    icon: "Sparkles",
    affectedRoles: ["GURU", "ADMIN", "SUPER_ADMIN"],
    sortOrder: 30,
  },
  {
    code: "FEAT_AI_IMAGE",
    name: "AI Builder — Materi Gambar",
    description: "Generate ilustrasi & diagram materi/soal dengan AI (Fase 2)",
    isActive: false,
    tier: FeatureTier.PREMIUM,
    category: "akademik",
    icon: "Image",
  ...
  {
    code: "FEAT_AI_DESIGN",
    name: "AI Builder — Aset Visual CMS",
    description: "Generate banner, hero/slider, cover program, gambar popup & landing page dengan AI (Fase 2b)",
    isActive: false,
    tier: FeatureTier.PREMIUM,
    category: "operasional",
    icon: "Sparkles",
    affectedRoles: ["SUPER_ADMIN", "ADMIN"],
    sortOrder: 32,
  },
  {
    code: "FEAT_AI_AUDIO",
    name: "AI Builder — Materi Audio",
    description: "Generate narasi materi (text-to-speech) dengan AI (Fase 3)",
    isActive: false,
    tier: FeatureTier.PREMIUM,
    category: "akademik",
    icon: "Sparkles",
  ...
  {
    code: "FEAT_AI_VIDEO",
    name: "AI Builder — Materi Video",
    description: "Generate video pembelajaran audio-visual dengan AI (Fase 4)",
    isActive: false,
    tier: FeatureTier.PREMIUM,
    category: "akademik",
    icon: "Sparkles",
...
async function main() {
  ...
  const siteConfigs = [
    ...
    { key: "counter_items", value: "students,teachers,classes,subjects,programs,branches,affiliates" },
    ...
    { key: "counter_fake_programs", value: "8" },
    { key: "counter_fake_branches", value: "3" },
    { key: "counter_fake_affiliates", value: "25" },
    // Program & testimonial section
    { key: "program_style", value: "grid" },
    { key: "program_count", value: "4" },
    { key: "program_filter", value: "all" },
    { key: "program_marquee_direction", value: "left" },
    { key: "program_marquee_speed", value: "30" },
    { key: "program_carousel_autoplay", value: "true" },
    { key: "program_carousel_loop", value: "true" },
    { key: "program_carousel_interval", value: "5" },
    { key: "testimonial_style", value: "grid" },
    { key: "testimonial_count", value: "3" },
    { key: "testimonial_filter", value: "all" },
    { key: "testimonial_marquee_direction", value: "left" },
    { key: "testimonial_marquee_speed", value: "30" },
    { key: "testimonial_carousel_autoplay", value: "true" },
    { key: "testimonial_carousel_loop", value: "true" },
    { key: "testimonial_carousel_interval", value: "5" },
    // Header type & layout
