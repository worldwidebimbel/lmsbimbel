...
export const FEATURE_CODES = {
  ...
  PWA: "FEAT_PWA",
  PPDB: "FEAT_PPDB",
  AFFILIATE: "FEAT_AFFILIATE",
  ROOM_MANAGEMENT: "FEAT_ROOM_MANAGEMENT",
  AUDIT_LOG: "FEAT_AUDIT_LOG",
  AI_QUESTION: "FEAT_AI_QUESTION",
  AI_BUILDER: "FEAT_AI_BUILDER",
  AI_IMAGE: "FEAT_AI_IMAGE",
  AI_DESIGN: "FEAT_AI_DESIGN",
  AI_AUDIO: "FEAT_AI_AUDIO",
  AI_VIDEO: "FEAT_AI_VIDEO",
  HOMEPAGE_CMS: "FEAT_HOMEPAGE_CMS",
  TEACHING_JOURNAL: "FEAT_TEACHING_JOURNAL",
  REPORT_CARD: "FEAT_REPORT_CARD",
  TEACHER_ATTENDANCE: "FEAT_TEACHER_ATTENDANCE",
