...
export default async function OrangTuaRaportPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Raport Anak</h1>
          <p className="text-sm text-gray-500">Lihat raport anak yang telah dipublikasi</p>
        </div>
      </div>
            ...
            <div key={r.id} className="rounded-xl border border-gray-200 bg-white p-5 space-y-3">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">{r.class.name} — {r.class.subject?.name ?? "Tanpa Mapel"}</p>
                </div>
                {r.finalGrade !== null && (
