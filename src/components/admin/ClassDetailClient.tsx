            ...
            students.map((cs, idx) => (
              <div key={cs.student.id} className="flex items-center justify-between px-5 py-3 hover:bg-gray-50">
                ...
                <button
                  ...
                  title="Hapus" className="max-md:min-h-[44px] max-md:min-w-[44px] max-md:inline-flex max-md:items-center max-md:justify-center rounded-lg p-1.5 text-gray-300 hover:bg-red-50 hover:text-red-500"
                >
