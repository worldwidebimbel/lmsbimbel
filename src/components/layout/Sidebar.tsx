...
const NAV_ADMIN: NavItem[] = [
  ...
  { title: "AI Builder", href: "/guru/ai-builder", icon: "Sparkles", roles: ["SUPER_ADMIN", "ADMIN"], featureFlag: "FEAT_AI_BUILDER" },
...
const NAV_GURU: NavItem[] = [
  ...
  { title: "AI Builder", href: "/guru/ai-builder", icon: "Sparkles", featureFlag: "FEAT_AI_BUILDER" },
